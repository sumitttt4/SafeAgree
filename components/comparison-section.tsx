            ...
            <div className="container px-4 md:px-6 mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                    ...
                    <motion.div
                        ...
                        className="rounded-3xl border border-stone-200 bg-[#FDFBF7] p-8 md:p-12 space-y-8 relative overflow-hidden shadow-md group transform transition-transform hover:rotate-0"
                    >
                        ...
                        <div className="space-y-4 relative z-10">
                            <div className="h-12 w-12 bg-stone-200/50 rounded-xl flex items-center justify-center mb-4">
                                <FileText className="h-6 w-6 text-stone-500" />
                            </div>
                            <h3 className="text-2xl font-bold text-stone-800 font-serif">The Old Way</h3>
                            <p className="text-stone-500 font-medium">What you're doing right now.</p>
                        </div>
                        ...
                        <ul className="space-y-5 relative z-10">
                            {[
                                ...
                                <li key={i} className="flex items-start gap-4 text-stone-600/90 font-medium">
                    ...
                    <motion.div
                        ...
                        className="rounded-3xl border border-blue-100 bg-white p-8 md:p-12 space-y-8 relative overflow-hidden shadow-2xl shadow-blue-900/10 ring-1 ring-blue-500/5"
                    >
                        <div className="absolute top-0 right-0 p-32 bg-gradient-to-br from-blue-50 to-transparent rounded-bl-full -z-10 opacity-50" />
                        ...
                        <div className="space-y-4">
                            ...
                            <h3 className="text-2xl font-bold text-slate-900">The SafeAgree Way</h3>
                            <p className="text-blue-600 font-bold tracking-tight">Smart, fast, and protective.</p>
                        </div>
